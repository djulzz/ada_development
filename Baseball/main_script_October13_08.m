...
for i = 1 : 1 : nBBEntries
    ...
    nElements = length( shockInfoMatrix( :, 2 ) );
    avg_nPreshocks = mean( shockInfoMatrix( :, 2 ) );
    avg_nPostshocks = mean( shockInfoMatrix( :, 3 ) );
    fprintf( 'avg. # pre - shocks = %.2f - avg. # post - shocks = %.2f\n', avg_nPreshocks, avg_nPostshocks );
